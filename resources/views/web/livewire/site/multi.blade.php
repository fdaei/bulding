        ...
        <div class="row">
            <aside class="col-md-4 d-none d-md-block">
                <div class="container">
                    ...
                    <div class="list-group border mb-3">
                        ...
                        <ul class="sub-menu{{$key}}" style="display: none">
                            ...
                            <li class=" d-flex justify-content-between p-2 cursor-pointer" wire:click="changesidebar({{$item->id}})">
                                    {{$item->name}}
                                    <span>({{ \App\Http\Livewire\Web\Notice\IndexWire::countn($item->id)}})</span>
                            </li>
                            @empty
                            @endforelse
                        </ul>
                    ...
                    <p class="sidebar-multi"><b>دسته بندی بر حسب شهر و استان</b></p>
                    <div class="mb-3"><div class="d-flex">
                        ...
                        <div class="mb-3"><div class="d-flex">
                                <select class="p-2 m-1 form-control" wire:model="searchcity" wire:change="selectcity">
                                    <option value=""> شهرخود را انتخاب کنید </option>
                                    @if($cities)
